...
N = jPCA_settings.N
sim_matrix = np.load('/hpc/hers_en/fsimoes/logs/objects/NOT_ROUNDED_jaccard_matrix_N={}.npy'.format(N))
...
plt.title('NOT rounded reneralized Jaccard scores for N={}'.format(N))
plt.savefig('/hpc/hers_en/fsimoes/logs/images/NOT_ROUNDED_Histogram_Jaccard_scores_for_N={}.png'.format(N))
#plt.show()
