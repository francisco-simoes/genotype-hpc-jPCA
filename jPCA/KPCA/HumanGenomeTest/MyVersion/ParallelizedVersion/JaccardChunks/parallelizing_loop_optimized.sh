...
do
	...
	sbatch --job-name=jaccard_chunks /hpc/hers_en/fsimoes/execute.sh /hpc/hers_en/shared/wxs/miniconda3/bin/Rscript /hpc/hers_en/fsimoes/jPCA/KPCA/HumanGenomeTest/MyVersion/ParallelizedVersion/JaccardChunks/jPCA_chunks_parallel_optimized.R $minvar $chunksize
done
