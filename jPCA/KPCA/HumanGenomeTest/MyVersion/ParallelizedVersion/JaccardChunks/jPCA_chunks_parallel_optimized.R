...
saveRDS(different_positive_count,file=sprintf("/hpc/hers_en/fsimoes/jPCA/KPCA/HumanGenomeTest/MyVersion/ParallelizedVersion/JaccardChunks/mijs/diff_pos_count_%s.rds", minvar))
saveRDS(equal_positive_count,file=sprintf("/hpc/hers_en/fsimoes/jPCA/KPCA/HumanGenomeTest/MyVersion/ParallelizedVersion/JaccardChunks/mijs/eq_pos_count_%s.rds", minvar))
