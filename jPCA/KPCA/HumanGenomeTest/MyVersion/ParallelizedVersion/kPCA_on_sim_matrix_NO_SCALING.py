...
#Save it in .npy file.
#np.save('/hpc/hers_en/fsimoes/logs/objects/HumanGenomeTest/MyVersion/ParallelizedVersion/kPCA_X_kpca.npy', X_kpca)
#np.save('/hpc/hers_en/fsimoes/logs/objects/HumanGenomeTest/MyVersion/ParallelizedVersion/kPCA_X_kpca_common.npy', X_kpca)
np.save('/hpc/hers_en/fsimoes/logs/objects/HumanGenomeTest/MyVersion/ParallelizedVersion/kPCA_X_kpca.npy', X_kpca)
...
plt.title('kPCA: First two PCs for EUR human genome data; rare vars; parallelized')
#Create scatter plot:
plt.scatter(scores.PC1_score, scores.PC2_score)
#plt.savefig('/hpc/hers_en/fsimoes/logs/images/kPCA_PCs_SNPversion.png')
plt.savefig('/hpc/hers_en/fsimoes/logs/images/kPCA_PCs_eur_parallelized.png')
#plt.show()
